...
public class DefaultLibrarytestService implements LibrarytestService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultLibrarytestService.class);
	...
	{
		return DefaultLibrarytestService.class.getResourceAsStream("/librarytest/sap-hybris-platform.png");
	}
