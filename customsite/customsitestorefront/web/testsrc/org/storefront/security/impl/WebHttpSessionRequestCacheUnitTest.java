 ...
 */
package org.storefront.security.impl;
...
public class WebHttpSessionRequestCacheUnitTest
{
	...
	public void testCalcRedirectUrlWithEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/customsitestorefront/electronics/en",
						"https://electronics.local:9002/customsitestorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/customsitestorefront/electronics/en",
						"https://electronics.local:9002/customsitestorefront/electronics/en/"));
	...
	public void testCalcRedirectUrlWithMismatchEncodingAttrs()
	{
		assertEquals(
				"electronics/en",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/customsitestorefront/electronics/ja/Y/Z",
						"https://electronics.local:9002/customsitestorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/customsitestorefront/electronics/en",
						"https://electronics.local:9002/customsitestorefront/electronics/en/"));
	}
	...
	public void testCalcRedirectUrlWithoutEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/customsitestorefront",
						"https://electronics.local:9002/customsitestorefront"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/customsitestorefront",
						"https://electronics.local:9002/customsitestorefront/"));
	...
	public void testCalcRedirectUrlWithEncodingAttrsServletPath()
	{
		assertEquals(
				...
				executeCalculateRelativeRedirectUrl("electronics/en", "/customsitestorefront/electronics/en",
						"https://electronics.local:9002/customsitestorefront/electronics/en/Open-Catalogue/Cameras/Digital-Cameras/c/575"));
	}
