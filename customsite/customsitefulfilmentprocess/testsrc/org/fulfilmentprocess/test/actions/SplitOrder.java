 ...
 */
package org.fulfilmentprocess.test.actions;
...
public class SplitOrder extends TestActionTemp
{
	...
	public String execute(final BusinessProcessModel process) throws Exception
	{
		...
		warehouseCounter.setName(CustomsiteFulfilmentProcessConstants.CONSIGNMENT_COUNTER);
		...
		params.setName(CustomsiteFulfilmentProcessConstants.PARENT_PROCESS);
