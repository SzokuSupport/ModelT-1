 ...
 */
package org.fulfilmentprocess.actions.order;
...
import org.fulfilmentprocess.constants.CustomsiteFulfilmentProcessConstants;
...
public class FraudCheckOrderAction extends AbstractFraudCheckAction<OrderProcessModel>
{
	...
	public Transition executeAction(final OrderProcessModel process)
	{
		...
		final double scoreLimit = Double.parseDouble(Config.getParameter(CustomsiteFulfilmentProcessConstants.EXTENSIONNAME + ".fraud.scoreLimitExternal"));
		final double scoreTolerance = Double.parseDouble(Config.getParameter(CustomsiteFulfilmentProcessConstants.EXTENSIONNAME + ".fraud.scoreToleranceExternal"));
